...
# Plot Figure 1 (Comparison between sample mean and theoretical mean)
...
# Plot Figure 2 (Comparison between sample variance 
...
# Plot cumulative mean of the simulations to show the Law of Large Numbers
meanmns <- NULL
varmns <- NULL
for (i in 1:1000) {
        mns <- c(mns, mean(rexp(40, rate = 0.2)))
...
# Plot cumulative variance of the simulations to show the Law of Large Numbers
